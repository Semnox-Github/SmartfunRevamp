...
abstract class AuthenticationRepository {
  ...
  Future<Either<Failure, String>> getUserExecutionController(int selectedSite);
  Future<Either<Failure, int>> getConfigExecutionController();
  Future<Either<Failure, List<CustomerFieldConfiguration>>> getUserMetaData(int siteId);
  Future<Either<Failure, List<CountryData>>> getCountriesContainer(int siteId);
