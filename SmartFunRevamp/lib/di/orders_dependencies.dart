...
void ordersDependencies() {
  ...
  //Use Cases
  Get.lazyPut<GetCustomerTransactionsUseCase>(() => GetCustomerTransactionsUseCase(Get.find()));
  Get.lazyPut<GetTransactionDetailUseCase>(() => GetTransactionDetailUseCase(Get.find()));
}
