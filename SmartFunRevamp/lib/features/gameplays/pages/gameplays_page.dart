              ...
              child: Consumer(
                builder: (context, ref, child) {
                  return ref.watch(GameplaysProvider.accountGameplaysProvider).maybeWhen(
                        ...
                        error: (e, s) => Center(
                          child: MulishText(
                            text: 'An error has ocurred ${(e as Failure).message}',
                            fontSize: 20.0,
                          ),
                        ),
                        ...
                        data: (data) {
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20), side: const BorderSide(color: Colors.white70)),
                                child: ListTile(
                                  ...
                                  subtitle: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                    MulishText(text: '\n${item.site}\nRef: ${item.gameplayId}', fontColor: Colors.black),
                                    const Icon(
