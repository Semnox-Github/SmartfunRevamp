...
class RechargeCardDetailsButton extends ConsumerWidget {
  RechargeCardDetailsButton(
      {Key? key, required this.cardDetails, required this.cardIndex})
      : super(key: key);
  late final CardDetails cardDetails;
  late final DateTime timeNow = DateTime.now();
  late final DateTime expirationDate = cardDetails.expiryDate != null
      ? DateTime.parse(cardDetails.expiryDate.toString())
      : timeNow;
          ...
          children: [
            ...
            Expanded(
              child: SecondaryButton(
                label: SplashScreenNotifier.getLanguageLabel('CARD DETAILS'),
                onTap: () => Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => CardDetailPage(
                        cardDetails: cardDetails, cardIndex: cardIndex),
                  ),
                ),
              ),
              // Container(
