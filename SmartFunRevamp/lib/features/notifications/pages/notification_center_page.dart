    ...
    return Consumer(builder: (_, WidgetRef ref, __) {
      ...
      return Scaffold(
        appBar: AppBar(
          ...
          foregroundColor: HexColor.fromHex(cmsPageHeader?.textColor),
          iconTheme:
              IconThemeData(color: HexColor.fromHex(cmsPageHeader?.textColor)),
          centerTitle: false,
          actions: [
            Consumer(
            ...
            IconButton(
              onPressed: () =>
                  Navigator.pushNamed(context, Routes.kNotificationsSettings),
              icon: Icon(
                Icons.settings,
                color: HexColor.fromHex(cmsPageHeader?.textColor),
              ),
        ...
        body: SafeArea(
          ...
          child: Consumer(
            builder: (context, ref, child) {
              return ref
                  .watch(NotificationsProvider.notificationsStateProvider)
                  .maybeWhen(
                    orElse: () => Container(),
