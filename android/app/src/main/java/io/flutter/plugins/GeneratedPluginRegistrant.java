...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.semnox.parafait.barcode_reader.BarcodeReaderPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin barcode_reader, com.semnox.parafait.barcode_reader.BarcodeReaderPlugin", e);
    }
    try {
