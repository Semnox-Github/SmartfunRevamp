...
class PosMachineDTO {
  ...
  static List<PosMachineDTO>? getPosMachineDTOList(List<dynamic>? dtoList) {
    if (dtoList == null) {
      return null;
    }

    List<PosMachineDTO> posMachineviewDTOList = [];
    for (var element in dtoList) {
      posMachineviewDTOList.add(PosMachineDTO.fromJson(element));
    }
